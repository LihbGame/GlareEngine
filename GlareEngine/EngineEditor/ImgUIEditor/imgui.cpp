...
ImGuiStyle::ImGuiStyle()
{
    ...
    DisplaySafeAreaPadding  = ImVec2(3,5);      // If you cannot see the edge of your screen (e.g. on a TV) increase the safe area padding. Covers popups/tooltips as well regular windows.
