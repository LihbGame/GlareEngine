...
void D3DApp::OnResize()
{
	...
	//更新视口转换以覆盖客户端区域。
	mScreenViewport.TopLeftX = mClientWidth*1.0f/6.0f;
	mScreenViewport.TopLeftY = MainMenuBarHeight;
	mScreenViewport.Width    = static_cast<float>(mClientWidth*2.0f/3.0f);
	mScreenViewport.Height   = static_cast<float>(mClientHeight*0.75f- MainMenuBarHeight);
