...
private:
    ...
    static const Noesis::RoutedEvent* FindRoutedEvent(NsSymbol eventName,
        const Noesis::TypeClass* type);
    void OnRoutedEvent(Noesis::BaseComponent* sender, const Noesis::RoutedEventArgs& e);
    static const Noesis::TypeProperty* FindEvent(NsSymbol eventName, const Noesis::TypeClass* type);
