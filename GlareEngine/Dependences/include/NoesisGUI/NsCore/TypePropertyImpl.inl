...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class C, class T>
T TypePropertyFunction<C,T>::ByRef::GetCopy(GetterFn, const void*)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class C, class T>
T TypePropertyFunction<C,T>::ByCopy::GetCopy(GetterFn getter, const void* ptr)
{
    return (static_cast<const C*>(ptr)->*getter)();
}
...
{
    *(T*)storage = Helper::GetCopy(mGetter, ptr);
}
