...
:fxc_vs
    ...
    fxc /T vs_4_0 /nologo /O3 %debug_options%  /Qstrip_reflect -D__XBOX_DISABLE_SHADER_NAME_EMPLACEMENT=1 -D__XBOX_FULL_PRECOMPILE_PROMISE=1 -D__XBOX_DISABLE_PRECOMPILE_LS=1 -D__XBOX_DISABLE_PRECOMPILE_ES=1 /Fo %1.o %2 %3 %4 %5 > NUL
    bin2h.py %1.o %1 >> Shaders.xbox.h
    del %1.o
    EXIT /B 0

:fxc_ps
    :: set debug_options=/Zi /Qstrip_debug /Fd pdb/%1.pdb
    fxc /T ps_4_0 /nologo /O3 %debug_options% /Qstrip_reflect -D__XBOX_DISABLE_SHADER_NAME_EMPLACEMENT=1 -D__XBOX_FULL_PRECOMPILE_PROMISE=1 /Fo %1.o %2 %3 %4 %5 > NUL
    bin2h.py %1.o %1 >> Shaders.xbox.h
    del %1.o
    EXIT /B 0