...
{
	void ShadowBuffer::Create(const std::wstring& Name, uint32_t Width, uint32_t Height, DXGI_FORMAT Format,uint32_t arraySize, D3D12_GPU_VIRTUAL_ADDRESS VidMemPtr)
	{
		DepthBuffer::Create(Name, Width, Height, Format, false, arraySize, VidMemPtr);
