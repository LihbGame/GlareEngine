...
namespace GlareEngine
{
	namespace Math
	{
		...
		public:
			...
			INLINE explicit operator XMFLOAT3() const { XMFLOAT3 Temp; XMStoreFloat3(&Temp, m_vec); return Temp; }
			...
			INLINE Vector3& operator *= (float  v2) { *this = *this* Scalar(v2); return *this;}
			INLINE Vector3& operator += (Vector3 v) { *this = *this + v; return *this; }
			INLINE Vector3& operator -= (Vector3 v) { *this = *this - v; return *this; }
			INLINE Vector3& operator *= (Vector3 v) { *this = *this * v; return *this; }
			INLINE Vector3& operator /= (Vector3 v) { *this = *this / v; return *this; }
			INLINE bool		operator != (Vector3 v) { 
				if ((float)this->GetX() != (float)v.GetX()
		...
		public:
			...
			INLINE explicit Vector4(Vector3 xyz) { m_vec = SetWToZero(xyz); }
