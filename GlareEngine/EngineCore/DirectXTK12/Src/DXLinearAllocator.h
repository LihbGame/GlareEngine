...
namespace DirectX
{
    class DXLinearAllocatorPage
    {
    public:
        DXLinearAllocatorPage() noexcept;

        DXLinearAllocatorPage(DXLinearAllocatorPage&&) = delete;
        DXLinearAllocatorPage& operator= (DXLinearAllocatorPage&&) = delete;

        DXLinearAllocatorPage(DXLinearAllocatorPage const&) = delete;
        DXLinearAllocatorPage& operator=(DXLinearAllocatorPage const&) = delete;
    ...
    protected:
        friend class DXLinearAllocator;

        DXLinearAllocatorPage*                    pPrevPage;
        DXLinearAllocatorPage*                    pNextPage;
    ...
    public:        
        ...
        DXLinearAllocator(DXLinearAllocator&&) = default;
        DXLinearAllocator& operator= (DXLinearAllocator&&) = default;

        DXLinearAllocator(DXLinearAllocator const&) = delete;
        DXLinearAllocator& operator=(DXLinearAllocator const&) = delete;

        ~DXLinearAllocator();

        DXLinearAllocatorPage* FindPageForAlloc(_In_ size_t requestedSize, _In_ size_t alignment);
    ...
    private:
        DXLinearAllocatorPage*                    m_pendingPages; // Pages in use by the GPU
        DXLinearAllocatorPage*                    m_usedPages;    // Pages to be submitted to the GPU
        DXLinearAllocatorPage*                    m_unusedPages;  // Pages not being used right now
        size_t                                  m_increment;
        size_t                                  m_numPending;
        size_t                                  m_totalPages;
        ...
        DXLinearAllocatorPage* GetPageForAlloc(size_t sizeBytes, size_t alignment);
        DXLinearAllocatorPage* GetCleanPageForAlloc();

        DXLinearAllocatorPage* FindPageForAlloc(DXLinearAllocatorPage* list, size_t sizeBytes, size_t alignment) noexcept;

        DXLinearAllocatorPage* GetNewPage();

        void UnlinkPage(DXLinearAllocatorPage* page) noexcept;
        void LinkPage(DXLinearAllocatorPage* page, DXLinearAllocatorPage*& list) noexcept;
        void LinkPageChain(DXLinearAllocatorPage* page, DXLinearAllocatorPage*& list) noexcept;
        void ReleasePage(DXLinearAllocatorPage* page) noexcept;
        void FreePages(DXLinearAllocatorPage* list) noexcept;

#if defined(_DEBUG) || defined(PROFILE)
        std::wstring m_debugName;

        static void ValidateList(DXLinearAllocatorPage* list);
        void ValidatePageLists();

        void SetPageDebugName(DXLinearAllocatorPage* list) noexcept;
#endif
    };
}
