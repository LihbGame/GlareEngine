...
void GlareEngine::EngineProfiling::Update()
{
}

void GlareEngine::EngineProfiling::BeginBlock(const std::wstring& name, DirectX12Graphics::CommandContext* Context)
{
}

void GlareEngine::EngineProfiling::EndBlock(DirectX12Graphics::CommandContext* Context)
{
}

bool GlareEngine::EngineProfiling::IsPaused()
{
	return false;
}